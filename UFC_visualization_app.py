...
from tables import get_all_tables

app = Dash(__name__, suppress_callback_exceptions = True)
server = app.server

df, df_2, df_3, table_data, wins_method, lose_method, df_winner, \
df_loser, df_winner5, df_winner3, df_loser3, df_loser5, fighter_names, weight_classes = get_all_tables()
